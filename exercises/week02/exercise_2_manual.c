...
int main(){
    ...
    This part tests the hand-coded copying variant.*/
    int i, N = 200000;
    float a[N], b[N];
    ...
    clocks_end = clock();
    double time_manual = (double)(clocks_end - clocks_begin) / CLOCKS_PER_SEC;
    printf("Time consumed with manual copying: %f seconds.\n", time_manual);
